...
public class Vista6Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anteriorButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Vista6Activity2.this, Vista5Activity2.class);
    ...
    private void handleFinishButtonClick() {
        ...
        Intent intent=new Intent(Vista6Activity2.this, Vista7Activity2.class);
        startActivity(intent);
    }
}